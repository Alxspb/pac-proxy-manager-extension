        ...
        <div className="space-y-6 min-h-[250px]">
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-4">
                <div className="flex items-center justify-between mb-4">
                    <h3 className="text-lg font-semibold text-gray-900">{messages.aboutTitle}</h3>
                </div>
                ...
                <div className="space-y-6">
                    ...
                    <div className="text-gray-600 text-sm space-y-2">
                        ...
                        <p>
                            {messages.aboutMadeBy}{' '}
                            <a
                                className="text-blue-500 hover:text-blue-600 underline"
                                href="https://github.com/ilyachase"
                                target="_blank"
                        ...
                        <div className="flex items-center gap-1">
                            ...
                            <a
                                className="text-blue-500 hover:text-blue-600 underline"
                                href="https://github.com/ilyachase/pac-proxy-manager-extension"
                                target="_blank"
                                rel="noopener noreferrer"
                            >
                                {messages.aboutSourceCodeLink}
                            </a>
                        </div>
                        <div className="flex items-center gap-1">
